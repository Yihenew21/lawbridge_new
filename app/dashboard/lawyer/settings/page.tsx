    ...
    <DashboardShell role="lawyer">
      <div className="p-6 lg:p-8">
        ...
        >
          ...
          <p className="mt-1 text-muted-foreground">Manage your account and professional preferences.</p>
        </motion.div>
              ...
              <CardContent className="flex flex-col gap-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-2">
                    ...
                    <Input defaultValue="Abeba" className="bg-secondary/50 border-border/50" />
                  </div>
                  <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Input defaultValue="abeba@example.com" type="email" className="bg-secondary/50 border-border/50" />
                </div>

                <div className="flex flex-col gap-2">
                  <Label htmlFor="phone">Phone Number</Label>
                  <Input defaultValue="+251 911 567890" className="bg-secondary/50 border-border/50" />
                </div>

                <div className="flex flex-col gap-2">
                  <Label htmlFor="experience">Years of Experience</Label>
                  <Input defaultValue="10" type="number" className="bg-secondary/50 border-border/50" />
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Textarea
                    ...
                    defaultValue="Experienced family law attorney with 10+ years of practice."
